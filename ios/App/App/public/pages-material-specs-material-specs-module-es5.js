(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-material-specs-material-specs-module"], {
    ...
    function yW(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "MaterialSpecsPage", function () {
        return MaterialSpecsPage;
      });
      /* harmony import */
      ...
      var _raw_loader_material_specs_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./material-specs.page.html */
      "cepN");
      /* harmony import */


      var _material_specs_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./material-specs.page.scss */
      "aDmI");
      /* harmony import */
      ...
      var MaterialSpecsPage = /*#__PURE__*/function () {
        // this is used to read in the material id from the previous page
        function MaterialSpecsPage(http, route, router) {
          var _this = this;

          _classCallCheck(this, MaterialSpecsPage);

          this.http = http;
          this.route = route;
          this.router = router; // holds material information to be displayed on the page

          this.materialResult = [];
          this.route.queryParams.subscribe(function (params) {
            if (_this.router.getCurrentNavigation().extras.state) {
              _this.materialObj = _this.router.getCurrentNavigation().extras.state.searchResults;
            }
          });
          this.loadMaterial();
        }

        _createClass(MaterialSpecsPage, [{
          key: "loadMaterial",
          value: function loadMaterial() {
            // set material_id to the value of the passed material ID based on what was pressed
            this.materialObj = this.router.getCurrentNavigation().extras.state.searchResults; // if there is no image path set the image path to display not-found.jpg image
            ...
            this.materialResult.push({
              name: this.materialObj["materialName"],
              type: this.materialObj["materialType"],
              description: this.materialObj["materialDescription"],
              image: imgPath
            }); // Let database know a material was viewed

            var obj = {
              func: "material_viewed",
              materialID: this.materialObj["materialID"]
            };
      ...
      MaterialSpecsPage.ctorParameters = function () {
        return [{
      ...
      MaterialSpecsPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    /***/
    function aDmI(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function cepN(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function kL3D(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "MaterialSpecsPageModule", function () {
        return MaterialSpecsPageModule;
      });
      /* harmony import */
      ...
      var _material_specs_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./material-specs-routing.module */
      "yAsV");
      /* harmony import */


      var _material_specs_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./material-specs.page */
      "87yW");

      var MaterialSpecsPageModule = function MaterialSpecsPageModule() {
        _classCallCheck(this, MaterialSpecsPageModule);
      };

      MaterialSpecsPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _material_specs_routing_module__WEBPACK_IMPORTED_MODULE_5__["MaterialSpecsPageRoutingModule"]],
    ...
    /***/
    function yAsV(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "MaterialSpecsPageRoutingModule", function () {
        return MaterialSpecsPageRoutingModule;
      });
      /* harmony import */
      ...
      var _material_specs_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./material-specs.page */
      "87yW");
      ...
      var MaterialSpecsPageRoutingModule = function MaterialSpecsPageRoutingModule() {
        _classCallCheck(this, MaterialSpecsPageRoutingModule);
      };

      MaterialSpecsPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
...
//# sourceMappingURL=pages-material-specs-material-specs-module-es5.js.map