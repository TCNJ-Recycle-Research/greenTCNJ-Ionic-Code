(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~home-home-module~pages-schedule-schedule-module"], {
    /***/
    "L+Ny":
    /*!*******************************************************************************!*\
        ...
        _createClass(EventModalPage, [{
          ...
          value: function registerForEvent() {
            ...
            this.storage.get('userID').then(function (val) {
              ...
              var obj = {
                ...
                userID: val,
                eventID: _this9.eventID,
                attendance: 0
              };

              _this9.http.post("https://recycle.hpc.tcnj.edu/php/participants-handler.php", JSON.stringify(obj)).subscribe(function (data) {
                var result = data;

                if (result["addSuccess"]) {
                  _this9.eventObj.registered = _this9.registered = true;
                }
              });
            });
          ...
          value: function unregisterForEvent() {
            ...
            this.storage.get('userID').then(function (val) {
              ...
              _this10.http.post("https://recycle.hpc.tcnj.edu/php/participants-handler.php", JSON.stringify(obj)).subscribe(function (data) {
                var result = data;

                if (result["deleteSuccess"]) {
                  _this10.eventObj.registered = _this10.registered = false;
                }
              });
            });
          }
...
//# sourceMappingURL=default~home-home-module~pages-schedule-schedule-module-es5.js.map