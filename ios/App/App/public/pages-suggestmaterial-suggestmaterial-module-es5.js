(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-suggestmaterial-suggestmaterial-module"], {
    ...
    /***/
    function gKz(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function EpqJ(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function T7Tf(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SuggestmaterialPage", function () {
        return SuggestmaterialPage;
      });
      /* harmony import */
      ...
      var _raw_loader_suggestmaterial_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./suggestmaterial.page.html */
      "EpqJ");
      /* harmony import */


      var _suggestmaterial_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./suggestmaterial.page.scss */
      "3gKz");
      /* harmony import */
      ...
      var SuggestmaterialPage = /*#__PURE__*/function () {
        // firstName: new FormControl()
        function SuggestmaterialPage(router, http, formBuilder, storage) {
          var _this = this;

          _classCallCheck(this, SuggestmaterialPage);
          ...
          this.emailInput = "";
          this.wordSent = false;
          this.today = new Date(Date.now()); // responsible for printing error messages to the screen based on validator 
          ...
          this.validation_messages = {
            'word': [{
              ...
              type: 'maxlength',
              message: 'Your suggested material must be less than 30 characters long.'
            }, {
              type: 'required',
        ...
        _createClass(SuggestmaterialPage, [{
          key: "submitWord",
          value: function submitWord() {
            ...
            if (!this.wordForm.valid) {
              ...
              console.log("VALID");
              this.wordSent = true; // Find a way to get email and password input from user

              var obj = {
                func: "add_request",
                requestMaterial: this.wordForm.value['word'],
                requestDescription: this.wordForm.value['description'],
                userEmail: this.usrEmail
              };
              this.http.post("https://recycle.hpc.tcnj.edu/php/material-requests-handler.php", JSON.stringify(obj)).subscribe(function (data) {
                var result = data;

                if (result['missingInput']) {
                  // output to user it succeeded and move to next page
                  _this2.wordSent = false;
                } else {
                  _this2.wordSent = true;

                  _this2.wordForm.reset();
                }
              });
            }
          }
      ...
      SuggestmaterialPage.ctorParameters = function () {
        return [{
      ...
      SuggestmaterialPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    /***/
    function peSJ(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SuggestmaterialPageModule", function () {
        return SuggestmaterialPageModule;
      });
      /* harmony import */
      ...
      var _suggestmaterial_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./suggestmaterial-routing.module */
      "s4Xr");
      /* harmony import */


      var _suggestmaterial_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./suggestmaterial.page */
      "T7Tf");
      /* harmony import */
    ...
    /***/
    function s4Xr(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SuggestmaterialPageRoutingModule", function () {
        return SuggestmaterialPageRoutingModule;
      });
      /* harmony import */
      ...
      var _suggestmaterial_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./suggestmaterial.page */
      "T7Tf");
      ...
      var SuggestmaterialPageRoutingModule = function SuggestmaterialPageRoutingModule() {
        _classCallCheck(this, SuggestmaterialPageRoutingModule);
      };

      SuggestmaterialPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
...
//# sourceMappingURL=pages-suggestmaterial-suggestmaterial-module-es5.js.map