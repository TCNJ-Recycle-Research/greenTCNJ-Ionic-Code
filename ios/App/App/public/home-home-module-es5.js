(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["home-home-module"], {
    ...
    function ctP(module, __webpack_exports__, __webpack_require__) {
      ...
      var _pages_event_modal_event_modal_module__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      ...
      HomePageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["IonicModule"], _ionic_storage__WEBPACK_IMPORTED_MODULE_9__["IonicStorageModule"].forRoot(), _home_routing_module__WEBPACK_IMPORTED_MODULE_6__["HomePageRoutingModule"], ionic2_calendar__WEBPACK_IMPORTED_MODULE_7__["NgCalendarModule"], _pages_event_modal_event_modal_module__WEBPACK_IMPORTED_MODULE_8__["EventModalPageModule"]],
    ...
    function zpKS(module, __webpack_exports__, __webpack_require__) {
      ...
      var HomePage = /*#__PURE__*/function () {
        function HomePage(userService, menuCtrl, locale, router, http, storage) {
          var _this = this;
          ...
          storage.get('userID').then(function (val) {
            ...
            _this.http.post("https://recycle.hpc.tcnj.edu/php/users-handler.php", JSON.stringify(obj)).subscribe(function (data) {});
          });
          storage.get('userName').then(function (val) {
            _this.welcomeMsg = "Welcome to Green TCNJ " + val + "!";
          });
        }

        _createClass(HomePage, [{
          key: "loadMyEvents",
          value: function loadMyEvents() {
            var _this2 = this;
            ...
            this.storage.get('userID').then(function (val) {
              ...
              _this2.http.post("https://recycle.hpc.tcnj.edu/php/events-handler.php", JSON.stringify(obj)).subscribe(function (data) {
                var result = data;

                for (var i = 0; i < result.length; i++) {
                  // turns the event date into a date format
                  var tempDate = new Date(result[i]["eventDate"]); // for loop to show any events if they are scheduled for today

                  if (tempDate.getMonth() + 1 == _this2.today.getMonth() + 1 && tempDate.getDate() + 1 == _this2.today.getDate() && tempDate.getFullYear() == _this2.today.getFullYear()) {
                    _this2.events.push({
      ...
      HomePage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
        ...
        imports: [_ionic_storage__WEBPACK_IMPORTED_MODULE_8__["IonicStorageModule"].forRoot()]
      })], HomePage);
      /***/
    }
  }]);
